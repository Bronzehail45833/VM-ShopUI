...
public $Blocks = [
  ...
  public $Mobs = [
    "ICON" => ["Mobs",52,0],
    "Blaze" => [52,61,60000,1000],
    "Iron Golem" => [52,99,500000,1000],
    "Skeleton" => [52,51,50000,1000],
    "Zombie" => [52,54,50000,1000],
    "Pig" => [383,47,50000,1000],
    "Zombie_Pigman" => [52,57,50000,1000],
    "Sheep" => [383,33,50000,1000],
